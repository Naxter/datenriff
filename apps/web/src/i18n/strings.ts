...
const EN: Dict = {
  ...
  'ui.close': 'Close',
  'ui.reset': 'Reset view',
  'ui.resetHint': 'Back to the whole country',
  'pages.about': 'About',
  ...
  'tooltip.near': 'near',
  'source.modified': 'data modified',
  'source.boundaries': 'Boundaries',
  'source.dataset': 'Dataset',
  'source.dataSources': 'Data sources',
...
const DE: Dict = {
  ...
  'ui.tools': 'Menü',
  'ui.close': 'Schließen',
  'ui.reset': 'Ansicht zurücksetzen',
  'ui.resetHint': 'Zurück auf das ganze Land',
  'pages.about': 'Über',
  ...
  'source.dataset': 'Datensatz',
  'source.dataSources': 'Datenquellen',
