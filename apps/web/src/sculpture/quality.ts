...
/** `?quality=mobile|desktop` overrides detection — also how it is tested. */
...
/** Shadows can also be forced off for software renderers (`?shadows=0`). */
export function shadowsEnabled(profile: QualityProfile): boolean {
