// The country outline and the city labels the renderer draws.
//
// Both are small, stable and needed by two scripts — the manifest builder
// writes them into the data folder, and the demo seeder places synthetic
// cells inside the outline and clusters them around the cities. Keeping one
// copy means the demo cannot drift into a differently shaped Germany.
